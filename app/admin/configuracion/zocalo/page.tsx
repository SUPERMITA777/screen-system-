...
export default function ZocalConfigPage() {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          ...
          description: "La configuración del zócalo se ha guardado correctamente",
        })
      } else {
        const data = await response.json()
  ...
  return (
    <div className="container mx-auto py-6">
      <h1 className="text-2xl font-bold mb-6">Configuración del Zócalo</h1>

      <form onSubmit={handleSubmit}>
        <Card>
          <CardHeader>
            <CardTitle>Zócalo Inferior</CardTitle>
            <CardDescription>Configura el texto y las imágenes que aparecen en la barra inferior</CardDescription>
          </CardHeader>

          <CardContent className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="zocal-text">Texto del zócalo</Label>
              <Input
                id="zocal-text"
                value={config.text}
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="zocal-enabled">Mostrar zócalo</Label>
            </div>
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="zocal-static">Texto estático (sin movimiento)</Label>
            </div>
